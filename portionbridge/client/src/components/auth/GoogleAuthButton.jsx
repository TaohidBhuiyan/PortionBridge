...
export function GoogleAuthButton({ onSuccess, onError, label = "Continue with Google", disabled = false, className = "" }) {
  ...
  return (
    <button
      ...
      className={`w-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6d45bd]/40 p-0.5 disabled:cursor-not-allowed bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 disabled:bg-gray-100 disabled:text-gray-500 rounded-xl ${className}`}
    >
