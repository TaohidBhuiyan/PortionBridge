...
function StatCard({ icon: Icon, label, value, suffix = '', tone = 'primary', loading, error }) {
  ...
  return (
    <div className={`bg-surface rounded-lg border border-border/50 p-3 ${HOVER_BORDER_CLASSES[tone] || HOVER_BORDER_CLASSES.primary} transition-colors duration-150`}>
...
function RatingCard({ averageRating, totalRatings, loading, error }) {
  ...
  return (
    <div className="bg-surface rounded-lg border border-border/50 p-3 hover:border-warning/30 transition-colors duration-150">
