      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-3 flex-1">
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <div className="h-5 w-4 bg-surface-hover rounded animate-pulse" />
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-4">
          <div className="relative w-full">
            <div className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 bg-surface-hover rounded animate-pulse" />
            <div className="w-full h-10 bg-surface-hover/60 rounded-lg animate-pulse" />
          </div>
        </div>

        {/* Right Section */}
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-lg bg-surface-hover animate-pulse" />
          <div className="w-10 h-10 rounded-lg bg-surface-hover animate-pulse" />
