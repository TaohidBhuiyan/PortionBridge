...
function StatCard({ icon: Icon, label, value, suffix = '', tone = 'primary', loading, error }) {
  ...
  return (
    <div className={`bg-surface rounded-lg border border-border/50 p-3 ${hoverBorderClass} transition-[border-color,box-shadow,transform] duration-150 hover:shadow-pb-card hover:-translate-y-0.5`}>
