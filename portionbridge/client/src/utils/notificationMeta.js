...
const TYPE_META = {
  ...
  team_join_request_received: { icon: Users, tone: 'primary' },
  team_join_request_accepted: { icon: Users, tone: 'success' },
  team_join_request_rejected: { icon: Users, tone: 'neutral' },
